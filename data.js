...
const SITE_CONFIG = {
    title: "未开放的资料库",
    subtitle: "[ 限制访问 ] [ 误入请退出 ] [ 非法访问将追踪 ]"字幕: “[ 限制访问 ] [ 误入请退出 ] [ 非法访问将追踪 ]”
};
...
const POSTS = [
    ...
    { id: "history4", section: "history", title: "公司部门",   poster: "[匿名]", desc: "■■■■■■■■■■ ■■■■■■■■■■ ■■■■", file: "history4.txt" },{ id: "history4", section: "历史", title: "公司部门",   poster: "[匿名]", desc: "■■■■■■■■■■ ■■■■■■■■■■ ■■■■", file: "history4.txt" },
    ...
    // ===== 居民档案公告 =====
    { id: "announce1", section: "residents", title: "公告：档案格式与撰写规则", poster: "[管理员]", desc: "■■■■■■■■■■ ■■■■■■■■■■ ■■■■", file: "announce1.txt" }{ id: "announce1", section: "居民", title: "公告：档案格式与撰写规则", poster: "[管理员]", desc: "■■■■■■■■■■ ■■■■■■■■■■ ■■■■", file: "announce1.txt" }
];
