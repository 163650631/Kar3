...
const POSTS = [
    // 历史资料
    { id: "history1", section: "history", title: "遗失的历史", poster: "[匿名]", desc: "〔你应当了解〕白雾吞噬土地，旧秩序消失，公司成为权力机构，人类退居小小的城市里，围墙外大雾弥漫。" },
    { id: "history2", section: "history", title: "薄雾街",     poster: "[匿名]", desc: "〔你应当了解〕悲慈地被划分为里城（博爱之城）和外城（薄雾街），我们的舞台定位在薄雾街三区，雾随时可能蔓延过来。" },
    { id: "history3", section: "history", title: "博爱之城",   poster: "[匿名]", desc: "〔你应当了解〕得到前往博爱之城的空白通行证。" },
    { id: "history4", section: "history", title: "公司部门",   poster: "[匿名]", desc: "〔不必了解〕悲慈地的权力机构，十公司和四部门，陈词滥调。" },
    // 白雾
    { id: "fog1", section: "fog", title: "雾中的世界",   poster: "[匿名]", desc: "〔你或许应当了解〕在城市之外，雾中的世界" },
    { id: "fog2", section: "fog", title: "对白雾的研究", poster: "[匿名]", desc: "〔你或许应当了解〕对白雾的研究，比如如何在雾区行走" },
    { id: "fog3", section: "fog", title: "恐雾症",       poster: "[匿名]", desc: "〔你或许应当了解〕受到白雾或者白雾里某种特质的影响，一些人患得恐雾症，并得到了相应的能力……" },
    { id: "fog4", section: "fog", title: "？？？",       poster: "[未知]", desc: "对绝大多数人来说，无知是件好事，不要阅读它!" },
    // 公告
    { id: "announce1", section: "residents", title: "公告：档案格式与撰写规则", poster: "[管理员]", desc: "〔你应当了解〕人设格式，与审核标准" }
];
