...
const POSTS = [
    ...
    { id: "history2", section: "history", title: "薄雾街",     poster: "[匿名]", desc: "城市被划分为里城〔博爱之城〕和外城〔薄雾街〕。我们的故事开展在薄雾街三区，雾随时可能蔓延过来，需要尽快逃离" },
    { id: "history3", section: "history", title: "博爱之城",   poster: "[匿名]", desc: "得到前往博爱之城的空白通行证" },
    { id: "history4", section: "history", title: "公司部门",   poster: "[匿名]", desc: "悲慈地的权力机构，十公司和四部门。乏善可陈的内容，作为对世界的扩展延伸。不必了解" },
    // 白雾
    ...
    // 公告
    { id: "announce1", section: "residents", title: "公告：档案格式与撰写规则", poster: "[管理员]", desc: "居民身份档案的格式与撰写规则**重要**" }
];
